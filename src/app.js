...
export class App extends LitElement {
	...
	async showHelpToast() {
		const { showSnackbar } = await import("./util/show-snackbar.js");
		showSnackbar(`A visual overview of RPA using web-skills`, {
			timeout: 1000 * 20,
			wide: true,
			buttons: [
	...
	render() {
		...
		return html`
			...
			<header id="header">
				<div>
					<a href="https://github.com/Jeehay28/RPA.git" target="_blank" rel="noopener" aria-label="Open Github" title="Open Github">
			...
			<footer id="footer">
				<div>
					<a href="https://github.com/Jeehay28/RPA/stargazers" target="_blank" aria-label="Become a stargazer" rel="noopener" >
						<ws-button>🌟 Become a stargazer 🌟</ws-button>
					</a>
					<a href="https://www.linkedin.com/in/jeehaypark/" target="_blank" aria-label="Open Twitter" rel="noopener">
						<ws-button> 👋 Say hi on LinkedIn 👋 </ws-button>
					</a>
				</div>
			</footer>
